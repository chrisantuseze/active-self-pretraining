...
def main():
    ...
    parser.add_argument(
        '--ckpt', default='./save/checkpoints/stylegan-256px-new.model', type=str, help='load from previous checkpoints'
    )
    parser.add_argument(
    ...
    train(args, dataset, generator, discriminator, g_optimizer, d_optimizer, g_running, code_size, n_critic)
