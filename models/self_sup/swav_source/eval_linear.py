...
parser.add_argument("--data_path", type=str, default="imagenet", #"/path/to/imagenet"
...
parser.add_argument("--pretrained", default="checkpoint.pth.tar", type=str, help="path to pretrained weights")
...
def main():
    ...
    if os.path.isfile(args.pretrained):
        state_dict = torch.load(args.pretrained, map_location="cuda:0") #+ str(args.gpu_to_work_on))
