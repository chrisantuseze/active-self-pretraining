...
from utils.commons import get_suffix, load_saved_state, save_accuracy_to_file, simple_save_model, simple_load_model
...
class Classifier:
    def __init__(self, args, pretrain_level="2") -> None: # this can also be called after the base pretraining to evaluate the performance
        ...
        if pretrain_level == "1":
            ...
            out = "swav_{}_checkpoint_{}_dal_val.tar".format(pretrain_level, get_suffix(args))
    ...
    def train_and_eval(self) -> None:
        ...
        save_accuracy_to_file(
            ...
            filename=f"classifier_{get_suffix(self.args)}.txt")
