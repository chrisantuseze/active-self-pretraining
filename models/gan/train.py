...
def generate_samples(model,img_prefix,batch_size):
    visualizers.reconstruct(model, img_prefix + "reconstruct.jpg", torch.arange(1), True)
    visualizers.interpolate(model, img_prefix + "interpolate.jpg", source=0, dist=1, trncate=0.3, num=1)
    visualizers.random(model, img_prefix + "random.jpg", tmp=0.3, n=1, truncate=True)
